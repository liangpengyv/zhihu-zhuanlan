    ...
    <div class="WriteIndexLayout-main WriteIndex">
      <div class="WriteCover-wrapper">
        <div class="WriteCover-previewWrapper WriteCover-previewWrapper--empty">
          <label class="UploadPicture-wrapper"><input type="file" accept=".jpeg, .jpg, .png" class="UploadPicture-input">
            <svg class="Zi Zi--Camera WriteCover-uploadIcon" fill="currentColor" viewBox="0 0 24 24" width="42" height="42">
      ...
      <div>
        <label class="WriteIndex-titleInput Input-wrapper Input-wrapper--multiline"><textarea rows="1" class="Input" placeholder="请输入标题（最多 50 个字）" style="height: 44px;"></textarea></label>
      </div>
      <div class="PostEditor-wrapper">
        <div class="InputLike PostEditor Editable">
          <div>
              ...
              <div class="Editable-toolbar-controls">
                ...
                <button aria-label="插入注释" data-tooltip="插入注释 (Ctrl+Shift+9)" data-tooltip-position="bottom" data-tooltip-will-hide-on-click="true" type="button" class="Button Editable-control Button--plain">
                  <svg class="Zi Zi--InsertReference" fill="currentColor" viewBox="0 0 24 24" width="24" height="24">
                    <path d="M5.002 6.5v11h.748a.75.75 0 1 1 0 1.5H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h1.75a.75.75 0 0 1 0 1.5h-.748zM11.066 9H9.81a.5.5 0 0 1-.447-.724l.5-1A.5.5 0 0 1 10.309 7H12.5a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-.996a.5.5 0 0 1-.5-.504L11.066 9zM19 17.5v-11h-.75a.75.75 0 1 1 0-1.5H20a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-1.75a.75.75 0 1 1 0-1.5H19z" fill-rule="evenodd"></path>
                  </svg>
                </button>
                <span class="Editable-toolbar-separator"></span>
                ...
                <button aria-label="上传图片" data-tooltip="上传图片" data-tooltip-position="bottom" data-tooltip-will-hide-on-click="true" type="button" class="Button Editable-control Button--plain">
                  <svg class="Zi Zi--InsertImage" fill="currentColor" viewBox="0 0 24 24" width="24" height="24">
                    <path d="M21 17.444C21 18.3 20.1 19 19 19H5c-1.1 0-2-.7-2-1.556V6.556C3 5.7 3.9 5 5 5h14c1.1 0 2 .7 2 1.556v10.888zm-9.437-3.919a.5.5 0 0 1-.862.013l-1.26-2.065a.5.5 0 0 0-.861.012l-2.153 3.767a.5.5 0 0 0 .435.748h10.292a.5.5 0 0 0 .438-.741L14.573 9.78a.5.5 0 0 0-.872-.006l-2.138 3.75z" fill-rule="evenodd"></path>
                  </svg>
                </button>
                <button aria-label="插入视频" data-tooltip="插入视频" data-tooltip-position="bottom" data-tooltip-will-hide-on-click="true" type="button" class="Button Editable-control Button--plain">
                  <svg class="Zi Zi--InsertVideo" fill="currentColor" viewBox="0 0 24 24" width="24" height="24">
                    <path d="M10.546 15c-.466.273-.86.053-.86-.5V9.505c0-.565.385-.778.86-.501l4.278 2.497c.466.272.475.726 0 1.003L10.546 15zM5 5S3 5 3 7v10s0 2 2.002 2H19c2 0 2-2 2-2V7c0-2-2-2-2-2H5z" fill-rule="evenodd"></path>
                  </svg>
                </button>
                ...
                <button aria-label="清除格式" data-tooltip="清除格式 (Ctrl+\)" data-tooltip-position="bottom" data-tooltip-will-hide-on-click="true" type="button" class="Button Editable-control Button--plain">
                  <svg class="Zi Zi--FormatClear" fill="currentColor" viewBox="0 0 24 24" width="24" height="24">
                    <path d="M9.864 12.83l1.641 1.642-1.171 2.874a1.693 1.693 0 0 1-1.585 1.055.782.782 0 0 1-.716-1.077l1.83-4.494zM11.5 8.811L12.24 7H9.69l-2-2h10.672a1 1 0 1 1 0 2h-3.813l-1.406 3.452L11.5 8.811zM5.293 6.845a1 1 0 0 1 1.414 0l10.046 10.046a1 1 0 0 1-1.414 1.414L5.293 8.26a1 1 0 0 1 0-1.415z" fill-rule="evenodd"></path>
                  </svg>
                </button>
                <button aria-label="上传附件" data-tooltip="上传附件" data-tooltip-position="bottom" data-tooltip-will-hide-on-click="true" type="button" class="Button Editable-control Button--plain">
                  <svg class="Zi Zi--Folder" fill="currentColor" viewBox="0 0 24 24" width="24" height="24">
                    <path d="M7.448 4.65a3.85 3.85 0 0 1 2.405.844l.856.685a2.15 2.15 0 0 0 1.343.471H18.5A2.35 2.35 0 0 1 20.85 9v7.5A2.85 2.85 0 0 1 18 19.35H6a2.85 2.85 0 0 1-2.85-2.85v-9A2.85 2.85 0 0 1 6 4.65zm11.701 7.05h-14.3l.001 4.8c0 .593.449 1.08 1.025 1.143L6 17.65h12a1.15 1.15 0 0 0 1.15-1.15l-.001-4.8zM7.448 6.35H6A1.15 1.15 0 0 0 4.85 7.5L4.849 10h14.3l.001-1a.65.65 0 0 0-.554-.643L18.5 8.35h-6.448a3.85 3.85 0 0 1-2.405-.844l-.856-.685a2.15 2.15 0 0 0-1.343-.471z"></path>
                  </svg>
                </button>
                <div class="Popover Editable-toolbarMenu">
                  <button aria-label="更多" data-tooltip="更多" data-tooltip-position="bottom" data-tooltip-will-hide-on-click="true" id="Popover3-toggle" aria-haspopup="true" aria-expanded="false" aria-owns="Popover3-content" type="button" class="Button Editable-control Button--plain">
                    <svg class="Zi Zi--Dots" fill="currentColor" viewBox="0 0 24 24" width="24" height="24">
          ...
          <div class="Dropzone Editable-content RichText RichText--editable RichText--clearBoth ztext" style="min-height: 38px;">
            <div class="DraftEditor-root">
              <div class="public-DraftEditorPlaceholder-root">
                <div class="public-DraftEditorPlaceholder-inner" id="placeholder-d8cq2" style="white-space: pre-wrap;">
                  请输入正文
                </div>
              </div>
              <div class="DraftEditor-editorContainer">
                <div aria-describedby="placeholder-d8cq2" class="notranslate public-DraftEditor-content" contenteditable="true" role="textbox" spellcheck="true" tabindex="0" style="outline: none; user-select: text; white-space: pre-wrap; overflow-wrap: break-word;">
                  <div data-contents="true">
                    <div class="Editable-unstyled" data-block="true" data-editor="d8cq2" data-offset-key="fqd4b-0-0">
                      <div data-offset-key="fqd4b-0-0" class="public-DraftStyleDefault-block public-DraftStyleDefault-ltr">
                        <span data-offset-key="fqd4b-0-0"><br data-text="true"></span></div>
                    </div>
                  </div>
                </div>
              </div>
...
<style scoped lang="less">
  @import "https://static.zhihu.com/heifetz/column.app.216a26f4.eb7dc2d67f537b0f505a.css";
  @import url("https://static.zhihu.com/heifetz/column.richinput.216a26f4.1c07e1b92a0c7056d1a9.css");
